...
df_customers = pd.read_excel(datapath + "my_shop_data.xlsx", sheet_name="customers")
df_order = pd.read_excel(datapath + "my_shop_data.xlsx", sheet_name="order")
df_employee = pd.read_excel(datapath + "my_shop_data.xlsx", sheet_name="employee")
df_products = pd.read_excel(datapath + "my_shop_data.xlsx", sheet_name="products")
